...
public class MatchDataAverageRobotSpeedRatingView extends MatchDataView implements IMatchDataView {

    public MatchDataAverageRobotSpeedRatingView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
