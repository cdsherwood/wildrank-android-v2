...
public class MatchDataGeomStatsGameHatchL3 extends MatchDataView implements IMatchDataView {

    public MatchDataGeomStatsGameHatchL3(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void calculateFromDocuments(List<Document> documents) {
        ...
        for (Document document : documents) {
            ...
            for (Map<String, Object> cycle : cycles) {      // throwing null pointer exception
                if ((boolean) cycle.get(CycleModel.RO_HATCH_SCORE_L3_KEY)) {
