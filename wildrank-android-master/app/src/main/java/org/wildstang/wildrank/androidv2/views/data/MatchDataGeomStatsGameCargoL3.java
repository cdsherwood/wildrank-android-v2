...
public class MatchDataGeomStatsGameCargoL3 extends MatchDataView implements IMatchDataView {

    public MatchDataGeomStatsGameCargoL3(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void calculateFromDocuments(List<Document> documents) {
        ...
        for (Document document : documents) {
            ...
            for (Map<String, Object> cycle : cycles) {      // throwing null pointer exception
                if ((boolean) cycle.get(CycleModel.RO_CARGO_SCORE_L3_KEY)) {
