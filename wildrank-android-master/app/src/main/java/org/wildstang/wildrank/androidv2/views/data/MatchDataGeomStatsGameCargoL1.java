...
public class MatchDataGeomStatsGameCargoL1 extends MatchDataView implements IMatchDataView {

    public MatchDataGeomStatsGameCargoL1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
