...
public class MatchDataGeomStatsGameCargoL2 extends MatchDataView implements IMatchDataView {

    public MatchDataGeomStatsGameCargoL2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void calculateFromDocuments(List<Document> documents) {
        ...
        for (Document document : documents) {
            ...
            for (Map<String, Object> cycle : cycles) {      // throwing null pointer exception
                if ((boolean) cycle.get(CycleModel.RO_CARGO_SCORE_L2_KEY)) {
