...
public class MatchDataGeomStatsCycles extends MatchDataView implements IMatchDataView {

    public MatchDataGeomStatsCycles(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
