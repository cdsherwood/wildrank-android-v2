...
public class MatchDataGeomStatsGameHatchL1 extends MatchDataView implements IMatchDataView {

    public MatchDataGeomStatsGameHatchL1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void calculateFromDocuments(List<Document> documents) {
        ...
        if (!didSomething) {
            ...
            if(geometricMean < 2.5) {
                textColor = "red";
            } else if (geometricMean > 5) {
                textColor = "green";
            }
